...
for k in range(0,2):
    ...
    for j in range(0,10):
        ...
        """ try:
            secti= driver.find_elements_by_xpath("//button[@class='Blockreact__Block-sc-1xf18x6-0 Buttonreact__StyledButton-sc-glfma3-0 fTomoL hJoTEY']").click()
        except:
            pass """
    #print(len(urls))
    ...
    try:
        ...
        #sectioo= driver.find_element_by_xpath("/html/body/div[1]/div/main/div/div[3]/button[2]']")
        sectioo.click()
        #driver.findElement_by_xpath("//a[contains(text(),101 - 201]").click()
        print("-------")
    except:
        print("<--->")
        pass        
