...
for i in s:
    ...
    def func_getans(lt_gtt):
        ...
        url= "https://api.opensea.io/api/v1/assets?"+xd+"&asset_contract_address=0x7bd29408f11d2bfc23c34f18275bbf23bb716bc7&offset=0&limit={}".format(len(lt_gtt)+1)
